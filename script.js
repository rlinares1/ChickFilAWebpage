...
function baconClicked(elem){
	document.getElementById("select-three").innerHTML = "<img src='images/toppings/horizontal/bacon-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
function pickleClicked(elem){
	document.getElementById("select-three").innerHTML = "<img src='images/toppings/horizontal/pickle-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
function tomatoClicked(elem){
	document.getElementById("select-three").innerHTML = "<img src='images/toppings/horizontal/tomato-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
function chickenClicked(elem){
	document.getElementById("select-four").innerHTML = "<img src='images/chicken/horizontal/chicken-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
function spicyClicked(elem){
	document.getElementById("select-four").innerHTML = "<img src='images/chicken/horizontal/spicy-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
function grilledClicked(elem){
	document.getElementById("select-four").innerHTML = "<img src='images/chicken/horizontal/grilled-side.png' width='250px' height='75px' class='centerpanel'>";
	p.play();
...
var bfin = false;
var w = document.getElementById("sfxcheer");
...
function changeWebsite(elem){
	if (bfin == true) {
		w.play();
		window.open("https://www.chick-fil-a.com/", "_blank");
	}
}